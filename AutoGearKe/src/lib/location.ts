// STEP 1 — Capacitor Geolocation (works on both web and native)
// On native: uses proper Android/iOS permission flow
...
export const requestLocation = async (): Promise<GeolocationPosition> => {
  try {
    ...
    // Convert Capacitor result to standard GeolocationPosition shape
    return {
      coords: {
