...
// dpr_auto → Automatically serve the right pixel density for the device
...
type ImageSize =
  ...
  | 'lqip';           // Low Quality Image Placeholder (tiny blurred version)

const SIZE_PARAMS: Record<ImageSize, string> = {
  profile_thumb:   'w_120,h_120,c_fill,g_face,q_auto,f_auto,dpr_auto',
  profile_full:    'w_300,h_300,c_fill,g_face,q_auto,f_auto,dpr_auto',
  card_cover:      'w_600,h_380,c_fill,q_auto,f_auto,dpr_auto',
  card_thumbnail:  'w_400,h_250,c_fill,q_auto,f_auto,dpr_auto',
  portfolio_thumb: 'w_400,h_300,c_fill,q_auto,f_auto,dpr_auto',
  portfolio_full:  'w_1200,h_900,c_limit,q_auto,f_auto,dpr_auto',
  article_inline:  'w_600,h_380,q_auto,f_auto,dpr_auto',
  article_thumb:   'w_400,h_380,c_fill,q_auto,f_auto,dpr_auto',
  cover_banner:    'w_1400,h_500,c_fill,q_auto,f_auto,dpr_auto',
  lqip:            'w_20,e_blur:1000,q_auto,f_auto', // Tiny 20px blurred placeholder
};
...
export const lqip            = (url: string) => getOptimisedUrl(url, 'lqip');
