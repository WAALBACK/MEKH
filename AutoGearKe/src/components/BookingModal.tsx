...
export const BookingModal = ({ 
  ...
  const validate = () => {
    ...
    if (!vehicleModel.trim()) newErrors.vehicle = 'Vehicle model is required';
    setErrors(newErrors);
        ...
        <form onSubmit={handleSubmit} className="p-6 space-y-4">
          ...
          <div>
            ...
            <select
              ...
              required
              className="w-full px-4 py-3 bg-slate-900 border-blue-600 rounded-lg text-slate-500 focus:outline-none focus:border-blue-500"
            >
