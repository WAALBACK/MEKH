...
export const ProfileCompletionModal = ({ isOpen, userType, onClose }: ProfileCompletionModalProps) => {
  ...
  const [trustedBrandsUsed, setTrustedBrandsUsed] = useState('');
        ...
        try {
          const { data, error: techError } = await supabase
            ...
            .insert([{
              ...
              trusted_brands_used: trustedBrandsUsed,
          ...
          <form onSubmit={handleSubmit}>
            ...
            {userType === 'technician' && step === 4 && (
              <div className="space-y-4">
                ...
                <div>
                  <label className="block text-sm font-medium text-slate-300 mb-1">Trusted Brands Used</label>
                  <input
                    type="text"
                    value={trustedBrandsUsed}
                    onChange={(e) => setTrustedBrandsUsed(e.target.value)}
                ...
                <div>
                  <label className="block text-sm font-medium text-slate-300 mb-1">Service Guarantee</label>
                  <textarea
