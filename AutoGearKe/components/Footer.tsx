...
const Footer: React.FC = () => {
  ...
  // Hide completely in PWA or native Capacitor app
  if (isPWA || Capacitor.isNativePlatform()) return null;
    ...
    return (
      <div className="flex items-center gap-5">
        ...
        <a href={PLAYSTORE_URL}
            ...
            aria-label="Download Mekh from Google Play Store"
            className="transition-all hover:scale-110"
        >
          <img src="/assets/playstore.png" alt="Google Play Store" className={size === 'lg' ? 'w-8 h-8' : 'w-6 h-6'} loading="lazy" decoding="async" width={size === 'lg' ? 32 : 24} height={size === 'lg' ? 32 : 24} />
        </a>
      </div>
    );
  };
        ...
        <div className="max-w-6xl mx-auto px-8 py-12">
          ...
          <div className="border-t border-slate-200 pt-6 flex flex-col md:flex-row items-center justify-between gap-3">
            <p className="text-blue-500 text-[11px] font-black uppercase tracking-widest">
              &copy; {currentYear} {BUSINESS_NAME}. Automotive Services Marketplace. Verified Technicians. Nairobi, Kenya.
            </p>
