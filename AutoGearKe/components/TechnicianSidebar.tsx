...
const TechnicianSidebar: React.FC<TechnicianSidebarProps> = ({ technician }) => {
  ...
  return (
    <aside className="hidden sm:flex flex-col w-64 bg-slate-900 border-r border-slate-800 h-full flex-shrink-0">
      {/* Profile Section */}
      ...
      {/* Navigation Links */}
      <nav className="flex-1 py-4 overflow-y-auto scrollbar-thin scrollbar-thumb-slate-700 scrollbar-track-slate-900">
        <Link 
          to="/" 
