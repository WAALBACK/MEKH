    ...
    <div className="min-h-screen bg-slate-950 text-slate-50 pb-24">
      ...
      <div className="bg-blue-600 p-6 border-b border-slate-800 relative overflow-hidden">
        ...
        <div className="flex items-center gap-4 relative z-10">
          <div className="w-16 h-16 rounded-full bg-white flex items-center justify-center text-blue-500 text-xl font-bold shadow-lg transform transition-transform hover:scale-110 duration-300">
      ...
      <div className="p-4">
        ...
        <div className="rounded-lg border border-blue-500 overflow-hidden shadow-lg">
          ...
          >
            ...
            <span className="text-blue-500 font-medium">Notifications</span>
          ...
          >
            ...
            <span className="text-blue-500 font-medium">Edit Profile</span>
            <svg className="w-4 h-4 text-blue-500 ml-auto opacity-0 group-hover:opacity-100 transition-opacity duration-300" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M9 5l7 7-7 7" />
            </svg>
          </Link>
          <button 
            ...
            className="flex items-center gap-3 p-4 bg-blue-500 hover:bg-blue-600 transition-all duration-300 w-full text-left group hover:pl-6 relative overflow-hidden"
          >
            ...
            <div className="flex flex-col relative z-10">
              <span className="text-slate-200 font-medium">Become a technician</span>
            </div>
