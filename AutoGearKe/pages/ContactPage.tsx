      ...
      <Helmet>
        ...
        <script type="application/ld+json">
          {JSON.stringify({
            ...
            '@type': 'ContactPage',
            name: 'Contact Mekh',
            description: 'Get in touch with Mekh for inquiries, complaints, or claims about our automotive services marketplace.',
            url: 'https://mekh.app/contact',
            mainEntity: {
              '@type': 'Organization',
              name: BUSINESS_NAME,
              contactPoint: [
