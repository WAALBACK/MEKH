...
const TechnicianMenuPage: React.FC = memo(() => {
  ...
  return (
    <div className="min-h-screen text-slate-50 pb-24 md:pb-8">
      {/* Profile Card */}
      <div className="bg-blue-600 p-6 border-b border-slate-800 relative overflow-hidden">
        {/* Animated gradient background */}
        <div className="absolute inset-0 bg-gradient-to-br from-blue-600/20 via-transparent to-blue-400/20 animate-pulse"></div>
        <div className="flex items-center gap-4 relative z-10">
          <div className="w-13 h-13 rounded-full bg-white flex items-center justify-center text-blue-500 text-xl font-bold overflow-hidden shadow-lg transform transition-transform hover:scale-110 duration-300">
          ...
          <div className="flex-1">
            ...
            <p className="text-[#ffff] font-medium">{fullName}</p>
            <p className="text-[#ffff] text-sm">{displayEmail}</p>
          </div>
          <div className="flex items-center gap-1">
            <span className={`w-2 h-2 rounded-full ${technician?.status === 'live' ? 'bg-green-500 animate-pulse' : 'bg-yellow-500'}`}></span>
            <span className="text-xs text-[#ffff] capitalize">{technician?.status || 'pending'}</span>
          </div>
        </div>
      </div>
      ...
      <div className="p-4">
        ...
        <div className="rounded-lg border border-blue-500 overflow-hidden shadow-lg">
          <Link 
            to={getProfileLink()} 
            className="flex items-center gap-3 p-4 border-b border-blue-500 hover:bg-blue-300 transition-all duration-300 group hover:pl-6"
          >
            <svg className="w-5 h-5 text-blue-500 transition-transform group-hover:scale-110 duration-300" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M16 7a4 4 0 11-8 0 4 4 0 018 0zM12 14a7 7 0 00-7 7h14a7 7 0 00-7-7z" />
            </svg>
            <span className="text-blue-500 font-medium">Profile</span>
            <svg className="w-4 h-4 text-blue-500 ml-auto opacity-0 group-hover:opacity-100 transition-opacity duration-300" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M9 5l7 7-7 7" />
            </svg>
          </Link>
          <Link 
            to={getNotificationLink()} 
            className="bg-blue-500 flex items-center gap-3 p-4 border-b border-blue-500 hover:bg-blue-600 transition-all duration-300 group hover:pl-6 relative overflow-hidden"
          >
            ...
            <svg className="w-5 h-5 text-white transition-transform group-hover:scale-110 duration-300 relative z-10" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M15 17h5l-1.405-1.405A2.032 2.032 0 0118 14.158V11a6.002 6.002 0 00-4-5.659V5a2 2 0 10-4 0v.341C7.67 6.165 6 8.388 6 11v3.159c0 .538-.214 1.055-.595 1.436L4 17h5m6 0v1a3 3 0 11-6 0v-1m6 0H9" />
            </svg>
            <span className="text-[#ffff] font-medium relative z-10">Notifications</span>
            <svg className="w-4 h-4 text-white ml-auto opacity-0 group-hover:opacity-100 transition-opacity duration-300 relative z-10" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M9 5l7 7-7 7" />
            </svg>
          </Link>
          <Link 
            to={getSettingsLink()} 
            className="flex items-center gap-3 p-4 hover:bg-slate-800/50 transition-all duration-300 group hover:pl-6"
          >
            <svg className="w-5 h-5 text-blue-500 transition-transform group-hover:scale-110 group-hover:rotate-90 duration-300" fill="none" stroke="currentColor" viewBox="0 0 24 24">
      ...
      <div className="p-4">
        ...
        <div className="rounded-lg border border-blue-500 overflow-hidden shadow-lg">
          ...
          >
            ...
            <span className="text-blue-500 font-medium">Estimate Cost</span>
            <svg className="w-4 h-4 text-blue-500 ml-auto opacity-0 group-hover:opacity-100 transition-opacity duration-300" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M9 5l7 7-7 7" />
            </svg>
          </Link>
...
TechnicianMenuPage.displayName = 'TechnicianMenuPage';
